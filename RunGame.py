...
def main_loop(game):
    while game.running:
        ...
        elif game.players[game.turnIndex].isBot and not(game.state.currentScreen == 'discard' and not game.needToDiscard[0].isBot) and game.state.currentScreen != 'ask player about trade':
